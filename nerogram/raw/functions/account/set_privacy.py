...
class SetPrivacy(TLObject):  # type: ignore
    ...
    Parameters:
        key (:obj:`InputPrivacyKey <nerogram.raw.base.InputPrivacyKey>`):
            N/A

        rules (List of :obj:`InputPrivacyRule <nerogram.raw.base.InputPrivacyRule>`):
            N/A

    Returns:
        :obj:`account.PrivacyRules <nerogram.raw.base.account.PrivacyRules>`
    """
