...
class UpdatePasswordSettings(TLObject):  # type: ignore
    ...
    Parameters:
        password (:obj:`InputCheckPasswordSRP <nerogram.raw.base.InputCheckPasswordSRP>`):
            N/A

        new_settings (:obj:`account.PasswordInputSettings <nerogram.raw.base.account.PasswordInputSettings>`):
            N/A
