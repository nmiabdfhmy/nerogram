...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <nerogram.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <nerogram.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <nerogram.raw.base.account.EmailVerified>`
    """
