...
class RecoverPassword(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        new_settings (:obj:`account.PasswordInputSettings <nerogram.raw.base.account.PasswordInputSettings>`, *optional*):
            N/A

    Returns:
        :obj:`auth.Authorization <nerogram.raw.base.auth.Authorization>`
    """
