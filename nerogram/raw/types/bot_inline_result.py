...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nerogram.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <nerogram.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <nerogram.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <nerogram.raw.base.WebDocument>`, *optional*):
            N/A
