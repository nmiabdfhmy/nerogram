...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nerogram.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <nerogram.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <nerogram.raw.base.Peer>`):
            N/A
