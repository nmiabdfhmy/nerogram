...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nerogram.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <nerogram.raw.base.SearchResultsPosition>`):
            N/A
