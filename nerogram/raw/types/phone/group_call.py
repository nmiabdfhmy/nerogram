...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nerogram.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <nerogram.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <nerogram.raw.base.GroupCallParticipant>`):
            N/A
