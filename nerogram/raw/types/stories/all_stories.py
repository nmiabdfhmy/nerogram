...
class AllStories(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nerogram.raw.base.stories.AllStories`.
    ...
    Parameters:
        ...
        peer_stories (List of :obj:`PeerStories <nerogram.raw.base.PeerStories>`):
            N/A
        ...
        stealth_mode (:obj:`StoriesStealthMode <nerogram.raw.base.StoriesStealthMode>`):
            N/A
