...
class TopPeerCategoryPeers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nerogram.raw.base.TopPeerCategoryPeers`.
    ...
    Parameters:
        category (:obj:`TopPeerCategory <nerogram.raw.base.TopPeerCategory>`):
            N/A

        count (``int`` ``32-bit``):
            N/A

        peers (List of :obj:`TopPeer <nerogram.raw.base.TopPeer>`):
            N/A
